// This page will contain all the common functionality that might exist between all pages within the webapp
// For example, the top panel
// Before login, it will only contains the My Booking App (assuming its a button or just a label)
// After login,
// We will have
